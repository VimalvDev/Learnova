  ...
  return (
    <div className="w-full h-full bg-[#1a1b1e] rounded-xl border border-white/[0.06] flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]">
        ...
        <div className="flex items-center gap-1.5 text-[10px] font-bold text-[#FA6E43] bg-[#FA6E43]/10 px-2.5 py-1 rounded-full border border-[#FA6E43]/20">
          94% confidence
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 px-4 py-2 border-b border-white/[0.04]">
        ...
        <span className="text-[9px] font-bold text-[#FA6E43] bg-[#FA6E43]/10 px-2 py-0.5 rounded-full border border-[#FA6E43]/15">
          DBMS_Notes.pdf
        </span>
        <span className="text-[9px] font-bold text-[#555] bg-white/[0.04] px-2 py-0.5 rounded-full border border-white/[0.06]">
          Lecture_Slides.pdf
        </span>
      </div>
...
<div className="flex flex-col items-start gap-1">
  ...
  <div className="self-start max-w-[85%] bg-[#FA6E43]/[0.08] border border-[#FA6E43]/15 rounded-xl rounded-tl-[3px] px-3 py-2 text-[11px] text-[#ccc] leading-relaxed">
...
<div className="flex flex-col items-start gap-1">
  <span className="text-[9px] font-bold uppercase tracking-widest text-[#444] px-1">Learnova AI</span>
  <div className="self-start bg-[#FA6E43]/[0.08] border border-[#FA6E43]/15 rounded-xl rounded-tl-[3px] px-4 py-3 flex items-center gap-1.5">
    {[0, 150, 300].map((d) => (
      <div
        key={d}
        className="w-1.5 h-1.5 rounded-full bg-[#FA6E43]/60 animate-bounce"
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-t border-white/[0.06]">
        ...
        <div className="w-7 h-7 rounded-lg bg-[#FA6E43] flex items-center justify-center flex-shrink-0 cursor-pointer hover:brightness-110 transition-all">
