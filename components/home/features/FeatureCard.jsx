...
export default function FeatureCard({
  ...
  return (
    <div
      className={`${colSpan} bg-[#212225] border border-white/[0.06] rounded-2xl overflow-hidden relative flex flex-col ${minHeight} hover:border-white/[0.12] transition-all duration-300`}
    >
      ...
      <div className="p-[1.8em] flex flex-col h-full gap-4 relative z-10">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1 pr-4">
            ...
            <span className="block text-[11px] font-bold uppercase tracking-widest text-[#FA6E43] mt-0.5">
              {num}
            </span>
