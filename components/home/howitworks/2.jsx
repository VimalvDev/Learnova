...
export default function HowItWorks() {
  ...
  return (
    <section
      className="py-[4em] relative overflow-hidden px-[1vw] md:px-[4vw] bg-card-dark "
      id="how-it-works"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[.8em] relative z-10">
        {/* Step 1 */}
        <div className="bg-card  p-[2em] relative rounded-2xl ">
          {/* Step number */}
          ...
          <p className="text-[#888] text-[14px] leading-relaxed mb-[1.8em] relative z-20">
            Drop PDFs, PPTs, or images. Our engine parses every detail and
        ...
        {/* Step 2 */}
        <div className="bg-card p-[2em] relative rounded-2xl hover:border-brand/30 hover:bg-brand/[0.04] duration-300 transition-all group">
          <div className="text-[11px] font-bold uppercase tracking-widest text-brand mb-[2em]">
            02
          </div>
          ...
          <p className="text-[#888] text-[14px] leading-relaxed mb-[1.8em] relative z-20">
            Engage with adaptive quizzes that adjust to your exact knowledge
            level. Ask questions directly from your material.
          </p>
        ...
        {/* Step 3 */}
        <div className="bg-card-dark border border-white/[0.06] p-[2em] relative rounded-2xl hover:border-brand/30 hover:bg-brand/[0.04] duration-300 transition-all group">
          <div className="text-[11px] font-bold uppercase tracking-widest text-brand mb-[2em]">
            03
          </div>
          ...
          <p className="text-[#888] text-[14px] leading-relaxed mb-[1.8em] relative z-20">
            Visual analytics show exactly what you know, what's fading, and what
            needs revision — concept by concept.
          </p>
