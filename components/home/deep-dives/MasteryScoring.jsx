...
export default function MasteryScoring() {
  return (
    <section id="mastery-scoring"   className="py-[4em] relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-[1em] mt-[3em]">
        ...
        <div className="md:col-span-4 flex flex-col gap-[1em]">
          ...
          <div className="bg-[#212225] border border-white/[0.06] rounded-2xl p-[1.8em]">
            ...
            <div className="bg-[#1a1b1e] rounded-xl p-4 font-mono text-[12px] text-[#888] leading-relaxed">
              ...
              {"  "}(Recency <span className="text-white">× 0.15</span>)
            </div>
          </div>

          {/* Signal cards */}
          {[
            { label: "Accuracy", value: "40%", desc: "Heaviest weight — measures raw correctness across all attempts.", color: "#FA6E43" },
            { label: "Speed Factor", value: "20%", desc: "Fast correct answers signal deeper understanding.", color: "#FA6E43" },
            { label: "Error Penalty", value: "25%", desc: "Recurring errors on the same concept reduce your score.", color: "#F87171" },
            { label: "Recency Boost", value: "15%", desc: "Recent correct answers boost your score — recent errors lower it.", color: "#FBBF24" },
        ...
        <div className="md:col-span-8 bg-[#212225] border border-white/[0.06] rounded-2xl p-[1.8em] flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4">
            {[
              { color: "#FA6E43", label: "Mastered (75%+)" },
              { color: "rgba(250,110,67,0.6)", label: "In Progress (50–74%)" },
              { color: "rgba(250,110,67,0.3)", label: "Critical (<50%)" },
            ].map(({ color, label }) => (
