...
export default function Hero() {
  return (
    ...
    <section
      id="home"
      className="min-h-screen pt-[10em] bg-dark pl-[5em] md:mb-[5em]  "
    >
        ...
        <div className="h-full w-full ">
          ...
          <div className=" flex md:flex-row flex-col h-full w-full  md:items-center md:mb-[3em] tracking-wide  ">
            ...
            <div className="hero_btn md:mr-[10em] md:mt-0 mt-[6em] md:ml-[2em] ">
              <Link
                href="/signup"
                className="bg-brand text-white px-5 py-3 rounded-xl text-lg font-bold hover:brightness-110 transition-all"
              >
                Learn now
              </Link>
            </div>
