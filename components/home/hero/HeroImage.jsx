  ...
  return (
    <div className="relative w-full h-full z-30">
      <div className="rounded-xl overflow-hidden border border-white/8 w-full h-full bg-card">
        ...
        {/* Window bar */}
        <div className="flex items-center gap-2 px-[2%] py-[1%] bg-[#1a1b1e]">
          ...
          <div className="mx-auto bg-white/5 rounded-md px-3 py-1 text-[1.2cqw] text-[#444]">
        ...
        <div className="grid h-[calc(100%-40px)]" style={{ gridTemplateColumns: "18% 82%" }}>
          ...
          <div className="flex flex-col gap-[1%] p-[3%] border-r border-white/10 h-full overflow-hidden">
            ...
            <div className="flex items-center gap-2 pb-[4%] mb-[2%] border-b border-white/10">
              <div className="w-[15%] aspect-square rounded-[25%] bg-brand flex items-center justify-center flex-shrink-0">
            ...
            <p className="text-[1cqw] font-bold uppercase tracking-widest text-[#444] mt-[2%]">Study</p>
            {["Dashboard", "My Courses", "RAG Chat", "Quizzes"].map((item, i) => (
              <div
                ...
                className={`flex items-center gap-[6%] px-[8%] py-[3%] rounded-lg text-[1.2cqw] truncate ${
                  i === 0 ? "bg-brand/10 text-brand" : "text-[#555]"
                }`}
              >
                <div className={`w-[6%] aspect-square rounded-full flex-shrink-0 ${i === 0 ? "bg-brand" : "bg-current"}`} />
                {item}
              </div>
            ))}

            <p className="text-[1cqw] font-bold uppercase tracking-widest text-[#444] mt-[4%]">Insights</p>
            {["Analytics", "Revision Plan", "Knowledge Map"].map((item) => (
              <div key={item} className="flex items-center gap-[6%] px-[8%] py-[3%] rounded-lg text-[1.2cqw] text-[#555]">
                <div className="w-[6%] aspect-square rounded-full flex-shrink-0 bg-current" />
            ...
            <div className="mt-auto p-[6%] rounded-lg border border-brand/15 bg-brand/8">
              ...
              <p className="text-[1cqw] text-[#555] mt-[2%]">In 2 hours</p>
            </div>
          </div>
          ...
          <div className="flex flex-col h-full min-w-0">
            ...
            <div className="flex items-center justify-between px-[2%] py-[1.5%] border-b border-white/5">
              <div>
                ...
                <p className="text-[1cqw] text-[#444] mt-[1%]">Database Systems · Week 4</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-[1%] p-[1.5%] h-full">
              ...
              <div className="flex flex-col items-center gap-[3%] p-[3%] rounded-xl border border-white/5 bg-[#1a1b1e]">
                <p className="text-[1cqw] font-bold uppercase tracking-widest text-[#555] self-start">Overall</p>
                <svg viewBox="0 0 80 80" className="w-[35%] h-auto">
                  <circle cx="40" cy="40" r="32" fill="none" stroke="rgba(255,255,255,0.05)" strokeWidth="7" />
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#FA6E43" strokeWidth="7"
              ...
              <div className="flex flex-col gap-[3%] p-[3%] rounded-xl border border-white/5 bg-[#1a1b1e]">
                <p className="text-[1cqw] font-bold uppercase tracking-widest text-[#555]">Concepts</p>
                {[
              ...
              <div className="col-span-2 flex items-center justify-between gap-4 p-[2%] rounded-xl border border-white/5 bg-[#1a1b1e]">
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-[2%]">
                    <div className="w-[0.6cqw] h-[0.6cqw] rounded-full bg-[#FBBF24] flex-shrink-0" />
                    <span className="text-[1cqw] text-[#555] truncate">Today · 3:00 PM · Spaced repetition</span>
                  </div>
                </div>
                <div className="flex flex-col items-center p-[2%] rounded-lg border border-brand/15 bg-brand/8 flex-shrink-0">
                  <span className="text-[2cqw] font-black text-brand leading-none">3</span>
                  <span className="text-[0.9cqw] text-[#555] mt-[4%]">due today</span>
                </div>
              </div>
              ...
              <div className="col-span-2 flex flex-col gap-[2%] p-[2%] rounded-xl border border-white/5 bg-[#1a1b1e]">
                <div className="flex items-center justify-between">
                  <p className="text-[1cqw] font-bold uppercase tracking-widest text-[#555]">RAG Context Chat</p>
                  <span className="text-[1cqw] font-bold px-[0.6em] py-[0.2em] rounded-full text-brand bg-brand/10">
                    94% confidence
                  </span>
                </div>
                <div className="text-[1.1cqw] text-[#aaa] px-[1.5%] py-[1%] self-start max-w-[75%] bg-white/5 rounded-lg rounded-tl-[2px]">
                  What is the difference between 2NF and 3NF?
                </div>
                <div className="text-[1.1cqw] text-[#ccc] px-[1.5%] py-[1%] self-end max-w-[80%] leading-relaxed bg-brand/8 border border-brand/15 rounded-lg rounded-br-[2px]">
                  ...
                  <div className="flex items-center gap-2 mt-[3%] pt-[3%] border-t border-white/5 text-[0.9cqw] text-[#444]">
                    <div className="w-[0.5cqw] h-[0.5cqw] rounded-full bg-brand flex-shrink-0" />
                    SOURCE: DBMS_Notes.pdf · Ch.4, Page 67
                  </div>
                </div>
                <div className="flex gap-[1%] mt-auto">
                  <div className="flex-1 rounded-lg px-[1.5%] py-[1%] text-[1.1cqw] text-[#444] bg-white/[0.04] border border-white/5">
                    Ask a follow-up question...
                  </div>
                  <div className="w-[4%] aspect-square rounded-lg bg-brand flex items-center justify-center flex-shrink-0">
