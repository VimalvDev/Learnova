...
const privateMessages = [
  ...
  {
    id: 2, type: "ai", time: "2:41 PM", confidence: 87,
    paragraphs: [
  ...
  { id: 4, type: "low_confidence", time: "2:43 PM", bestMatch: 41, threshold: 75 },
]
...
export default function CenterPanel({ mode = "private" }) {
  ...
  const handleSend = (text) => {
    ...
    setMessages((p) => [...p, { id: Date.now(), type: "user", text, time: now }])
    setThinking(true)
    setTimeout(() => {
      setThinking(false)
      setMessages((p) => [
        ...p,
        {
          ...
          bullets: ["Key concept point one", "Supporting definition or example", "Related topic"],
  ...
  return (
    <div className=" h-full w-full overflow-hidden relative">
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <div
            ...
            style={{
              background: isPublic ? "rgba(74,222,128,0.08)" : "rgba(250,110,67,0.08)",
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center">
            <div
              ...
              style={{ background: isPublic ? "rgba(74,222,128,0.08)" : "rgba(250,110,67,0.08)" }}
            >
              <span className="text-[18px]" style={{ color: accentColor }}>◈</span>
            </div>
          ...
          <>
            {messages.map((msg) =>
              msg.type === "user" ? (
                ...
                <LowConfidenceMessage key={msg.id} time={msg.time} bestMatch={msg.bestMatch} threshold={msg.threshold} />
              ) : (
      ...
      <InputBar onSend={handleSend} isPublic={isPublic} />
