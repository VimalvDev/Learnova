    ...
    <>
      ...
      <div className="px-5 py-5 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 bg-[#FA6E43] rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-[9px] text-[#FA6E43] font-bold uppercase tracking-wider mt-0.5">
              Student Portal
            </p>
          </div>
        </div>
        {onClose && (
          <button
            onClick={onClose}
            className="w-7 h-7 flex items-center justify-center rounded-lg bg-white/[0.04] text-[#555] hover:text-white hover:bg-white/[0.08] transition-all"
          >
      ...
      <div className="px-4 mb-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 px-3 py-2.5 bg-[#FA6E43]/10 rounded-xl cursor-pointer hover:bg-[#FA6E43]/15 transition-all">
          <RiBookOpenLine className="text-[#FA6E43] text-[14px] flex-shrink-0" />
            ...
            {items.map(({ icon: Icon, label: itemLabel, href, badge }) => {
              ...
              return (
                ...
                >
                  ...
                  {active && !badge && (
                    <RiArrowRightSLine className="text-[#FA6E43] text-[14px] flex-shrink-0" />
                  )}
                </Link>
              )
            })}
      ...
      <div className="p-4 flex-shrink-0 border-t border-white/[0.04]">
        <Link
          ...
          onClick={onClose ?? undefined}
          className="w-full h-9 bg-[#FA6E43] text-white text-[12px] font-bold rounded-xl flex items-center justify-center gap-2 hover:brightness-110 transition-all mb-3"
        >
          <MdOutlineUploadFile className="text-[15px]" />
          Upload Document
        </Link>
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-[11px] text-[#555]">Storage</span>
          <span className="text-[11px] text-[#555]">3.2 / 5 GB</span>
        </div>
        <div className="h-[3px] bg-white/[0.06] rounded-full overflow-hidden">
          <div className="h-full bg-[#FA6E43] rounded-full" style={{ width: "64%" }} />
        </div>
...
export function DashboardSidebar() {
  ...
  return (
   <aside className="hidden lg:flex w-[300px] flex-shrink-0 flex-col h-screen sticky top-0 z-40 bg-[#0D0D0D]">
...
export function DashboardMobileNav() {
  ...
  return (
    <>
      {/* Mobile topbar */}
      <div className="lg:hidden fixed top-0 left-0 right-0 h-[54px] z-50 bg-[#0D0D0D] flex items-center justify-between px-4">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-[#FA6E43] rounded-md flex items-center justify-center flex-shrink-0">
      ...
      {mounted && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          <div
            className="absolute left-0 top-0 h-full w-[270px] bg-[#0D0D0D] flex flex-col shadow-2xl transition-transform duration-300 ease-out"
