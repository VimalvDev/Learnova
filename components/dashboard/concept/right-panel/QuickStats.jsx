  ...
  return (
    <div className="bg-card rounded-2xl p-4">
      ...
      <div className="mt-3 bg-card-dark rounded-xl p-3">
        <p className="text-[10px] text-tertiary-text mb-2">You vs course average</p>
        <div className="flex items-center justify-between mb-1">
          <span className="text-[11px] text-secondary-text">Your mastery</span>
          <span className="text-[12px] font-semibold text-[var(--color-red)]">42%</span>
        </div>
        <div className="flex items-center justify-between mb-2">
          <span className="text-[11px] text-secondary-text">Course avg</span>
          <span className="text-[12px] font-semibold text-[#4ADE80]">64%</span>
        </div>
        <div className="h-px bg-card mb-2" />
        <div className="flex items-center justify-between">
          <span className="text-[10px] text-tertiary-text">Gap</span>
          <span className="text-[12px] font-bold text-[var(--color-red)]">−22%</span>
        </div>
        <p className="text-[10px] text-tertiary-text mt-1">Bottom 18% of learners</p>
      </div>
    </div>
  )
}