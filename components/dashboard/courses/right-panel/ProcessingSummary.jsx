  ...
  return (
    <div className="bg-[#171717] rounded-2xl p-5">
      ...
      <div className="flex flex-col gap-0">
        {[
          {
            ...
            extra: (
              <div className="flex flex-col gap-0.5 mt-1">
                ...
                <span className="text-[10px] text-[#FA6E43]">⟳ 1 processing</span>
        ...
        {/* Embeddings with bar */}
        <div className="py-3">
          <p className="text-[10px] uppercase tracking-widest text-[#555] mb-1">Vector Embeddings</p>
          <div className="flex items-center justify-between mb-1.5">
            <p className="text-[14px] font-semibold text-white">312 / 312</p>
            <span className="text-[10px] text-[#4ADE80]">✓</span>
          </div>
          <div className="h-[3px] bg-white/[0.06] rounded-full overflow-hidden">
            <div className="h-full bg-[#FA6E43] rounded-full" style={{ width: "100%" }} />
          </div>
        </div>
      </div>

      <div className="mt-4 py-2.5 px-3 bg-[#FA6E43]/8 rounded-xl text-center">
        <p className="text-[12px] text-[#FA6E43] font-medium">
          <span className="text-[#FA6E43]">◈</span> Knowledge base 60% ready
        </p>
      </div>
    </div>
  )
