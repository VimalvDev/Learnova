...
const handleSubmit = async () => {
  ...
  // Always go to onboarding — onboarding will redirect to dashboard if already complete
    ...
    <div className="bg-light-black border border-white/6 rounded-2xl p-8 sm:p-10 flex flex-col gap-7 shadow-2xl">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[11px] text-[#444] font-bold uppercase tracking-wider">or</span>
          <div className="flex-1 h-px bg-white/[0.06]" />
        </div>

        <AuthButton variant="google" loading={googleLoading} onClick={handleGoogleLogin}>
