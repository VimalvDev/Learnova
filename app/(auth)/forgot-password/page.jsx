...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="bg-[#1A1A1A] border border-white/6 rounded-2xl p-8 sm:p-10 flex flex-col items-center gap-6 text-center shadow-2xl">
        <div className="w-14 h-14 rounded-full bg-brand/10 border border-brand/20 flex items-center justify-center">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--color-brand)" className="w-7 h-7" strokeWidth="1.5">
  ...
  return (
    <div className="bg-[#1A1A1A] border border-white/6 rounded-2xl p-8 sm:p-10 flex flex-col gap-7 shadow-2xl">
