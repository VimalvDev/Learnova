        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className="max-w-[1440px] mx-auto flex flex-col gap-6">
            ...
            <div className="flex items-start justify-between pb-5 border-b border-(--color-card) flex-wrap gap-4">
              <div>
                <p className="text-[11px] text-tertiary-text mb-1">Admin / System Health</p>
                <h1 className="text-[clamp(20px,2.4vw,26px)] font-bold text-white">System Health</h1>
                <p className="text-[13px] text-tertiary-text mt-1">
                  Monitor server health, uptime, database performance, and system resources.
                </p>
              </div>
            ...
            <div className="p-6 bg-card rounded-2xl border border-(--color-card)">
              <p className="text-secondary-text">System Health content coming soon...</p>
            </div>
          </div>
        </div>
      </div>
