          ...
          <div className="max-w-[1440px] mx-auto flex flex-col gap-6">
            ...
            <div className="flex items-start justify-between pb-5 border-b border-(--color-card) flex-wrap gap-4">
              <div>
                ...
                <h1 className="text-[clamp(20px,2.4vw,26px)] font-bold text-white">Security Configuration</h1>
            ...
            <div className="p-6 bg-card rounded-2xl border border-(--color-card)">
              <p className="text-secondary-text">Security Configuration content coming soon...</p>
            </div>
          </div>
        </div>
      </div>
